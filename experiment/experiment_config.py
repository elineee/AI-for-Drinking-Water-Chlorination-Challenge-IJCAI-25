...
class ExperimentConfig:
    ...
    - disinfectant: the type of disinfectant (ContaminationType) used in the water (chlorine by default)
    ...
    - contaminant: a ContaminationType which is the contaminant to use (arsenic by default)
    ...
    contaminant: ContaminationType = ContaminationType.ARSENIC    
