...
if __name__ == "__main__":
    ...
    for node in nodes: 
        ...
        CONTAMINATED_FILES1 = [".\\data\\data_arsenic\\scada_data_conta_node_22_train_1.csv", ".\\data\\data_arsenic\\scada_data_conta_node_22_train_2.csv", ".\\data\\data_arsenic\\scada_data_conta_node_22_train_3.csv", ".\\data\\data_arsenic\\scada_data_conta_node_22_train_4.csv", ".\\data\\data_arsenic\\scada_data_conta_node_22_test_1.csv"]
        CONTAMINATED_FILES2 = [".\\data\\data_arsenic\\scada_data_conta_node_22_train_1.csv", ".\\data\\data_arsenic\\scada_data_conta_node_22_test_2.csv"]
        CONTAMINATED_FILES3 = [".\\data\\data_arsenic\\scada_data_conta_node_22_train_1.csv", ".\\data\\data_arsenic\\scada_data_conta_node_22_test_3.csv"]
